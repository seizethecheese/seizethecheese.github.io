...
There is a dll file written into a dir in WinSxS, which holds system recovery files.
- 'C:\Windows\WinSxS\x86_microsoft.windows.common-controls_6595b64144ccf1df_6.0.17763.2300_none_261b1acb67ca6493\comctl32.dll'

There is also a dll written to many different locations, however, I wasn't able to find this on disk to try and examine it.
- '瑮汤l.DLL'
