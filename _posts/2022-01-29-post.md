...
### VirusTotal
There is plenty to note in VirusTotal for the milos.dll file. To start VT reports the file name as 'FinalChatSocketCli.exe', this is also shown in PEStudio. Also of interest are the languages present, 53 of the sections are shown as Chinese vs 1 shown as English (RT_MANIFEST).
...
At this point I decided I was getting to far away from my original goal to look at maldoc malware samples so decided to stop here. This was difficult as this sample was really interesting!